...
explain CHR in 1st order here: \verb+\+ removes, \verb+<=>+ adds
...
with lp goals as constraints.  Eg one wants to write  propagation
rules like this one
...
the proof theoretic semantics of lp suggests that G has to be unified
