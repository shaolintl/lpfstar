...
\marginpar{see fix to is canonical}
...
system and use them to extend, in a modular way, the kernel into an elaborator.
...
We plan to compare in disciplined way the performance of the elaborator
