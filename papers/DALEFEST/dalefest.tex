...
To implement \verb+conv+ and \verb+sub+, we first implement weak head
...
For example, the following lines define the predicative hierarchy of types of Luo's ECC, using the integer $i$ to represent the universe $Type_i$.
\begin{verbatim}
lt I J :- I < J.
succ  I J :- J is I + 1.
max N M M :- N =< M.
