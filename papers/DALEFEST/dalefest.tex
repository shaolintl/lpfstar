...
metavariable, turning it into a proof obligation, i.e. a sequent of the form $\Gamma \vdash \mathtt{of}~X~t$\textcolor{red}{CSC: io ho usato $\vdash$ qui e là ma forse è meglio usare sempre \verb+?-+} where $\Gamma$ holds type declarations for variables (\verb+of x t+) or value assignments (\verb+val x t v nf+).
