...
We investigate if lp can do that too, if not what shall be added.
We the present a kernel and a prototype refiner for CIC

\section{The elaborator component of regular ITPs}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{$\lambda$Prolog and partial terms: problems}
